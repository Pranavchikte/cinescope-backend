        ...
        try:
            message = Mail(
                ...
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                    ...
                    <a href="{reset_link}" style="display: inline-block; padding: 12px 24px; background-color: #14B8A6; color: white; text-decoration: none; border-radius: 6px; margin: 16px 0;">Reset Password</a>
        ...
        try:
            message = Mail(
                ...
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                    ...
                    <a href="{verification_link}" style="display: inline-block; padding: 12px 24px; background-color: #14B8A6; color: white; text-decoration: none; border-radius: 6px; margin: 16px 0;">Verify Email</a>
                    <p>Or copy this link into your browser:</p>
